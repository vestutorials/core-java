...
import com.ves.tutorial.streams.model.Gender;
...
public class DataUtil {
	...
	public static List<Employee> getEmployeeList() {
		...
		employeeList.add(new Employee(3, "Andrew", 22, Gender.MALE, Designation.CLERK));
		...
		employeeList.add(new Employee(8, "Diana", 25, Gender.FEMALE, Designation.CLERK));
